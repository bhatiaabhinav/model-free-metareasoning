...
Adjust=True Random=True python -m MFMR.deepRL AWAstar-citynav-v0 Random 200000 --num_episodes_to_run=500 --algo_suffix=seed10_random_tc4_sim_ijcai --tags random sim ijcai c150 p150 nc3 pc3 --seed=10 --RPE_av_over=500 --no_render --no_monitor --overwrite &
