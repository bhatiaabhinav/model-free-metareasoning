...
Adjust=True python -m MFMR.deepRL A2.0Astar-20tsp-v0 Random 200000 --num_episodes_to_run=500 --algo_suffix=seed10_random_tc10_sim_20tsp_ijcai --tags random sim ijcai tsp15to25 --seed=10 --RPE_av_over=500 --no_render --no_monitor --overwrite &
